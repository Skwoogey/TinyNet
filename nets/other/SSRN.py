...
class ResnetBuilder(object):
    ...
    def build(input_shape, num_outputs, block_fn_spc, block_fn, repetitions1, repetitions2):
        ...
        #conv1 = _conv_bn_relu(nb_filter=32, kernel_dim1=3, kernel_dim2=3, kernel_dim3=input.shape[3], subsample=(1, 1, 1))(input)
...
def getModel(input_shape, num_classes):
    ...
    model = ResnetBuilder.build_resnet_8(input_shape_channels_first, num_classes)
