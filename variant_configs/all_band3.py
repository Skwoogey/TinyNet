...
def applyVariants(HSI_IH):
	...
	HSI_IH.addVariant(CoordSys([1, 2], [2, 1]))
	HSI_IH.addVariant(CoordSys([-1, 2], [-2, 1]))
	...
	HSI_IH.addVariant(CoordSys([0, 3], [3, 1]))
	HSI_IH.addVariant(CoordSys([0, 3], [3, -1]))
	HSI_IH.addVariant(CoordSys([0, 3], [3, 2]))
	HSI_IH.addVariant(CoordSys([0, 3], [3, -2]))
	HSI_IH.addVariant(CoordSys([0, 3], [3, 3]))
	HSI_IH.addVariant(CoordSys([0, 3], [3, -3]))
	HSI_IH.addVariant(CoordSys([3, 1], [0, 3]))
	HSI_IH.addVariant(CoordSys([3, -1], [0, 3]))
	HSI_IH.addVariant(CoordSys([3, 2], [0, 3]))
	HSI_IH.addVariant(CoordSys([3, -2], [0, 3]))
	HSI_IH.addVariant(CoordSys([3, 3], [0, 3]))
	HSI_IH.addVariant(CoordSys([3, -3], [0, 3]))
	
	HSI_IH.addVariant(CoordSys([1, 3], [3, 1]))
	HSI_IH.addVariant(CoordSys([-1, 3], [-3, 1]))
	HSI_IH.addVariant(CoordSys([2, 3], [3, 2]))
	HSI_IH.addVariant(CoordSys([-2, 3], [-3, 2]))
